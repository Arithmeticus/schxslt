...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <rdf:Description>
      ...
      <dc:date>2019-10-14T05:24:54.237-04:00</dc:date>
   </rdf:Description>
   ...
   <xsl:template match="/" mode="#default schxslt:supported.sch">
   ...
   <xsl:template match="text() | @*" mode="#default schxslt:supported.sch d10e7"/>
   <xsl:template match="* | processing-instruction() | comment()"
                 mode="#default schxslt:supported.sch d10e7">
               ...
               <xsl:if test="$report-test">
                  <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                     ...
                     <svrl:text>Test: <xsl:value-of select="ex:imprint-name($element-a)"/> 
                        <xsl:value-of select="ex:imprint-name($element-x)"/>
                     </svrl:text>
                  </svrl:successful-report>
               </xsl:if>
            </schxslt:rule>
